package com.datting_package.Flirty_Datting_App.VideoCalling;
...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        identity = SharedPrefrence.getString(this, SharedPrefrence.uId);
    ...
    public void Show_Calling_Dialog() {
        ...
        if (caller_image != null && !caller_image.equals("")) {
            Uri uri = Uri.parse(caller_image);
        ...
        pick_incoming_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (accessToken != null) {
                    ...
                    Functions.toastMsg(VideoActivity.this, "Problem in getting call token");
            }
        });
    ...
    public void do_action_on_status() {
        if (call_status.equals(Call_Pick)) {
            if (accessToken != null && calling_user_info_layout != null) {
                ...
                VideoActivity.this.connectToRoom(roomname);
                Functions.toastMsg(this, "Pick  call");
            }
        } else if (call_status.equals(Call_Receive)) {
            ...
            Functions.toastMsg(this, caller_name + " hang out the call");
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (requestCode == CAMERA_MIC_PERMISSION_REQUEST_CODE) {
            ...
            if (cameraAndMicPermissionGranted) {
                ...
                Functions.toastMsg(this, "Need mic and speaker permission");
            }
        }
    }
    ...
    private VideoCodec getVideoCodecPreference(String key, String defaultValue) {
        ...
        switch (videoCodecName) {
            case Vp8Codec.NAME:
                boolean simulcast = preferences.getBoolean(TwilioSettings.PREF_VP8_SIMULCAST,
    ...
    private EncodingParameters getEncodingParameters() {
        final int maxAudioBitrate = Integer.parseInt(
                preferences.getString(TwilioSettings.PREF_SENDER_MAX_AUDIO_BITRATE,
                        TwilioSettings.PREF_SENDER_MAX_AUDIO_BITRATE_DEFAULT));
        final int maxVideoBitrate = Integer.parseInt(
                preferences.getString(TwilioSettings.PREF_SENDER_MAX_VIDEO_BITRATE,
    ...
    private void retrieveAccessTokenfromServer() {
        StringRequest postRequest = new StringRequest(Request.Method.GET,
                ApiLinks.TWILIO_ACCESS_TOKEN_SERVER + identity + "?roomname=" + roomname,
    ...
    public void Send_notification(String call_status, String message) {
        ...
        String name = Functions.getInfo(VideoActivity.this, "first_name") + " " + Functions.getInfo(VideoActivity.this, "last_name");
        ...
        try {
            ...
            info.put("senderId", SharedPrefrence.getString(this, SharedPrefrence.uId));
    ...
    public void Start_limit_Timer() {
        limit_countDownTimer = new CountDownTimer(Variables.MAX_VIDEO_CALLING_TIME, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                if (call_type.equals("video_call")) {
                    int call_time = SharedPrefrence.getInt(VideoActivity.this, SharedPrefrence.videoCallingUsedTime);
                    SharedPrefrence.saveInt(VideoActivity.this, call_time + 1000, SharedPrefrence.videoCallingUsedTime);
                    if (call_time > Variables.MAX_VIDEO_CALLING_TIME) {
                        connectActionFab.performClick();
                    }
                } else {
                    int call_time = SharedPrefrence.getInt(VideoActivity.this, SharedPrefrence.voiceCallingUsedTime);
                    SharedPrefrence.saveInt(VideoActivity.this, call_time + 1000, SharedPrefrence.voiceCallingUsedTime);
