...
public class Drink_F extends RootFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Functions.addValuesToRv(list, Variables.ARR_LIST_DRINK);
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            if (adaptorPositionTotal == adpCurrentItemPosition) {
                ...
                EditProfileVp_A.colorRl.setBackgroundColor(ContextCompat.getColor(getActivity(),R.color.zink));
        ...
        adapter = new ProfileOptionsAdapter(getContext(), list, new AdapterClickListener() {
            ...
            public void onItemClick(int postion, Object model, View view) {
                ...
                Variables.varDrinking = item.getText();
                ...
                if (adaptorPositionTotal == adpCurrentItemPosition) {
                    ...
                    methodHidelinearlayout(EditProfileVp_A.profqsLl, EditProfileVp_A.descLl, EditProfileVp_A.happyLl,
                            EditProfileVp_A.genderLl, EditProfileVp_A.kidsLl, EditProfileVp_A.livingLl, EditProfileVp_A.drinkLl,
                            EditProfileVp_A.smokeLl, EditProfileVp_A.relationLl, EditProfileVp_A.bodytypeLl, EditProfileVp_A.missingLl);
