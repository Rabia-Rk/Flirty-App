...
import com.datting_package.Flirty_Datting_App.LiveStreaming.utils.WindowUtil;
import com.datting_package.Flirty_Datting_App.Utils.HugMeApplication;
...
public abstract class BaseActivity extends AppCompatActivity implements EventHandler {
    ...
    protected HugMeApplication application() {
        return (HugMeApplication) getApplication();
    }
