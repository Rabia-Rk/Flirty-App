...
public class NearbyUsersModel implements Serializable {
    String fb_id;
    String first_name;
    String last_name;
    String birthday;
    ...
    public NearbyUsersModel() {
    }

    public NearbyUsersModel(String fb_id, String first_name, String last_name, String birthday, String about_me,
